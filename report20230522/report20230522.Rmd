...
```{r, include=TRUE, fig.cap="FIGURE 3. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 4. Kaplan-Meier cumulative incidence curves. X-axis truncated at 28 days.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all_28.png")))
```


```{r, include=TRUE, fig.cap="FIGURE 5. Cox hazard ratios.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all.png")))
```

### Age subgroups

```{r, include=TRUE, fig.cap="FIGURE 6. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_50-64.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 7. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_65-74.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 8. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_75+.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 9. Cox hazard ratios.", out.width="70%", message=FALSE, warning=FALSE}
...
```{r, include=TRUE, fig.cap="FIGURE 10. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 11. Kaplan-Meier cumulative incidence curves. X-axis truncated at 28 days.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all_28.png")))
```


```{r, include=TRUE, fig.cap="FIGURE 12. Cox hazard ratios.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_all.png")))
```

### Age subgroups

```{r, include=TRUE, fig.cap="FIGURE 13. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_50-64.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 14. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_65-74.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 15. Kaplan-Meier cumulative incidence curves.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("km_{select_effect}_75+.png")))
```

```{r, include=TRUE, fig.cap="FIGURE 16. Cox hazard ratios.", out.width="70%", message=FALSE, warning=FALSE}
knitr::include_graphics(here(glue("report{release_date}"), "figures", select_effect, glue("cox_{select_effect}_age.png")))
```